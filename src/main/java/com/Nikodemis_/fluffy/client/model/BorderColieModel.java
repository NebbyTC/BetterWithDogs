...
public class BorderColieModel<T extends BorderColieEntity> extends EntityModel<T> {
    ...
    public BorderColieModel() {
        ...
        head.setTextureOffset(0, 3).addBox(0.0F, -5.0F, 0.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
