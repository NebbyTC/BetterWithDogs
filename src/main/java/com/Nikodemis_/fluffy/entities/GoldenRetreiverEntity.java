...
public class GoldenRetreiverEntity extends AnimalEntity {

    public static final Ingredient TEMPTATION_ITEMS = Ingredient.fromItems(Items.BONE);

    public GoldenRetreiverEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public AgeableEntity createChild(AgeableEntity ageable) {
        return ModEntityTypes.GOLDENRETREIVER.get().create(this.world);
    }
}
